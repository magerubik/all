...
use Magerubik\All\Model\Import\Behavior\BehaviorProviderInterface;
use Magerubik\All\Model\Import\Mapping\MappingInterface;
use Magerubik\All\Model\Import\Validation\EncodingValidator;
use Magerubik\All\Model\Import\Validation\ValidatorPoolInterface;
use Magerubik\All\Model\MagentoVersion;
...
abstract class AbstractImport extends AbstractEntity
{
    ...
    protected function processValidation(array $rowData)
    {
        ...
        foreach ($this->validatorPool->getValidators() as $validator) {
            ...
            } catch (\Magerubik\All\Exceptions\StopValidation $exception) {
